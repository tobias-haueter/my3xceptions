...
DEBUG get no file log:
    ...
    my3xceptions.logger.debug(f'   - [%s/msg()] -- This is a DEBUG --' % (os.path.basename(__file__)))

----------------------------------------------------------------------------------

INFO, WARNING, ERROR, CRITICAL get a file log:

    my3xceptions.logger.info(f'    - [%s/msg()] -- This is a INFO --' % (os.path.basename(__file__)))

    my3xceptions.logger.warning(f' - [%s/msg()] -- This is a WARNING --' % (os.path.basename(__file__)))

    my3xceptions.logger.error(f'   - [%s/msg()] -- This is a ERROR --' % (os.path.basename(__file__)))

    my3xceptions.logger.critical(f'- [%s/msg()] -- This is CRITICAL --' % (os.path.basename(__file__)))
...
def msg():
    logger.debug(f'   - [%s/msg()] -- This is a DEBUG --' % (os.path.basename(__file__)))
    logger.info(f'    - [%s/msg()] -- This is a INFO --' % (os.path.basename(__file__)))
    logger.warning(f' - [%s/msg()] -- This is a WARNING --' % (os.path.basename(__file__)))
    logger.error(f'   - [%s/msg()] -- This is a ERROR --' % (os.path.basename(__file__)))
    logger.critical(f'- [%s/msg()] -- This is CRITICAL --' % (os.path.basename(__file__)))
